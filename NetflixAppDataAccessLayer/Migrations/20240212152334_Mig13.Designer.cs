...
namespace NetflixAppDataAccessLayer.Migrations
{
    ...
    [Migration("20240212152334_Mig13")]
    partial class Mig13
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentEc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Id_EditorChoice")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_EditorChoice");

                    b.ToTable("CommentEcs");
                });

            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentMPM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Id_MostPopularMovie")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_MostPopularMovie");

                    b.ToTable("CommentMPMs");
                });

            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentMPT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Id_MostPopularTvShow")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_MostPopularTvShow");

                    b.ToTable("CommentMPTs");
                });

            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentTM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_Top250Movie");

                    b.ToTable("CommentTMs");
                });

            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentTT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Id_Top250TvShow")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_Top250TvShow");

                    b.ToTable("CommentTTs");
                });
            ...
            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentMPM", b =>
                {
                    b.HasOne("NetflixAppDomainLayer.Entities.Concretes.MostPopularMovie", "MostPopularMovie")
                        .WithMany("CommentMPMs")
                        .HasForeignKey("Id_MostPopularMovie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetflixAppDomainLayer.Entities.Concretes.CommentMPT", b =>
                {
                    b.HasOne("NetflixAppDomainLayer.Entities.Concretes.MostPopularTvShow", "MostPopularTvShow")
                        .WithMany("CommentMPTs")
                        .HasForeignKey("Id_MostPopularTvShow")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
