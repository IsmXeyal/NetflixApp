...
internal class CommentTTConfiguration : IEntityTypeConfiguration<CommentTT>
{
    public void Configure(EntityTypeBuilder<CommentTT> builder)
    {
        ...
        builder.HasOne(p => p.Top250TvShow)
            .WithMany(a => a.CommentTTs)
            .HasForeignKey(p => p.Id_Top250TvShow)
